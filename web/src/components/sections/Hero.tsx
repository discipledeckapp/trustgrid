          ...
          <div className="relative flex items-end gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 mt-1.5">
                <span className="text-[10px] bg-emerald-500/20 text-emerald-200 border border-emerald-500/30 rounded-full px-2 py-0.5">✓ NIN Verified</span>
                <span className="text-[10px] bg-white/15 text-white/80 rounded-full px-2 py-0.5">Available</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              <div className="flex -space-x-2">
                {['photo-1531384441138-2736e62e0919','photo-1507003211169-0a1dd7228f2d','photo-1438761681033-6461ffad8d80','photo-1472099645785-5658abf4ff4e'].map((id,i) => (
                  <img key={i} src={`https://images.unsplash.com/${id}?w=28&h=28&fit=crop&crop=face`} className="w-6 h-6 rounded-full border-2 border-slate-50 object-cover" alt="" />
                ))}
              </div>
              <span className="text-[10px] text-slate-400">12 endorsements</span>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-20 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up">
            <div className="inline-flex items-center gap-2 border border-indigo-200 bg-indigo-50 text-indigo-700 rounded-full px-4 py-1.5 text-sm font-medium mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a href="#request-demo"
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-bold text-white text-sm hover:opacity-90 transition-opacity shadow-lg shadow-indigo-200"
        ...
        <div className="flex justify-center mt-20">
          <a href="#problem" className="flex flex-col items-center gap-2 text-slate-300 hover:text-slate-500 transition-colors">
